...
def install_dependencies():
    ...
    run_command(["sudo", "apt-get", "install", "curl", "uuid-runtime", "-y"])
...
def install_xray():
    ...
    run_command(["sudo", "bash", install_script_path])
...
def configure_xray():
  ...
  "outbounds": [
    ...
    run_command([
        "bash",
        "-c",
        f'echo \'{config_content}\' | sudo tee {config_path} > /dev/null'
    ])
